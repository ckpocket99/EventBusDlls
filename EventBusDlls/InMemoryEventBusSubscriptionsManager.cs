...
namespace EventBusDlls
{
    ...
    public partial class InMemoryEventBusSubscriptionsManager : IEventBusSubscriptionsManager
    {
        ...
        private void DoAddSubscription(Type handlerType, string eventName, bool isDynamic)
        {
            ...
            {
                throw new ArgumentException($"Handler Type {handlerType.Name} alread registered for '{eventName}'", nameof(handlerType));
            }
        ...
        private SubscriptionInfo DoFindSubscriptionToRemove(string eventName,Type handlerType)
        {
            ...
            return _handlers[eventName].SingleOrDefault(v => v.HandlerType == handlerType);
        }
        ...
        private void DoRemoveHandler(string eventName, SubscriptionInfo subsToRemove)
        {
            if (subsToRemove != null)
            {
                ...
                if (!_handlers[eventName].Any())
                {
                    ...
                    var eventType = _eventTypes.SingleOrDefault(v => v.Name == eventName);
                    if (eventName != null)
                    {
